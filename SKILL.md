<!-- repository: packages/java/cache | kind: PACKAGE | stack: java-maven -->

# cache — Skill: Package Development

> Workflow for cache (packages/java/cache). Execute this workflow before, during, and
> after changes in this repository.

## Repository Facts

- Kind: Shared Package
- Package: `com.omnixys:cache` (version: 1.0.4)
- Runtime: Java 26 (Maven)
- Description: Valkey/Redis cache services: locking, rate limiting, pub/sub, streams, delayed jobs.
- Architecture: src/main/java/com/omnixys/cache/{core, service, model, health}
...
- This package is published (`com.omnixys:cache`); consumers pin versions and rely on SemVer.
